# 7DTD Show Weapon Sights/Crosshair in Third-Person View
...
### This is the source code, to use in-game go to: [7DTD-ShowWeaponSightsInThirdPersonView - Nexus](https://www.nexusmods.com/7daystodie/mods/9731)
